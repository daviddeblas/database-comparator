...
# Load the CSV file
data_path = 'results-pc-david/outputLoadAsyncMongo3.csv'
...
# Display the calculated confidence intervals for each workload (A, B, C)
print(ci_df)
